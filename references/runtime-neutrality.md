...
grep -nE "(在 Claude[ ]Code|Claude[ ]Code skill|Claude[ ]Code 用户|Cursor[ ]only|Codex[ ]中|^\[!\[Claude[ ]Code|~/\.claude/skills/[a-z]|/plugin[ ]install\b|darwin[-]skill|达[尔]文)" SKILL.md README.md 2>/dev/null
```
